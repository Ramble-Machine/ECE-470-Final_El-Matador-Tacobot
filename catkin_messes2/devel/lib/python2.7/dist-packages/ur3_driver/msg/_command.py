...
"""autogenerated by genpy from ur3_driver/command.msg. Do not edit."""
import sys
...
class command(genpy.Message):
  _md5sum = "c8890f8a9e9a6dc32b97081f6283bc11"
  _type = "ur3_driver/command"
...
bool io_0
"""
  __slots__ = ['destination','v','a','io_0']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2dB().pack(_x.v, _x.a, _x.io_0))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.v, _x.a, _x.io_0,) = _get_struct_2dB().unpack(str[start:end])
      self.io_0 = bool(self.io_0)
      return self
